              ...
              {filteredComplaints.map((complaint) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${complaint.status === "Pending"
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${complaint.priority === "High" ? "bg-red-100 text-red-800" : "bg-orange-100 text-orange-800"
                        }`}
                    >
                      {complaint.priority}
                    </span>
